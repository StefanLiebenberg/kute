 ...
 * {@link slieb.kute.api.Resource.Writeable}, {@link slieb.kute.api.Resource.InputStreaming},
...
public interface Resource extends Serializable {
    ...
    /**
     * The path the the given resource. This path is not to be confused with system path of the filesystem, even some overlap might exist. A resource exists within a {@link ResourceProvider} at its given path.
     *
    ...
    /**
     * This represents a Writeable resource. You can call {@link slieb.kute.api.Resource.Writeable#getWriter} on it to get a writer that will write to the resource.
     */
    ...
    /**
     * Proxy resources point to other resources that may or may not implement any of Readable, Writable, OutputStreaming,
    ...
    interface Proxy<A extends Resource> extends Resource, Readable, Writeable, OutputStreaming, InputStreaming {
        ...
        /**
         * This method proxies {@code getReader()} to it's composed resource's {@code getReader()} method, if and only if that resource
         ...
         * @throws IllegalStateException when the composed resource does not implement {@link slieb.kute.api.Resource.Readable}
         */
        @Override
        default Reader getReader() throws IOException {
         ...
         * @throws IllegalStateException when the composed resource does not implement {@link slieb.kute.api.Resource.OutputStreaming}
         */
        @Override
        default Writer getWriter() throws IOException {
